...
public class SSETest {
    ...
    public static HashMap convertDomains(Enumeration dw_domains, Enumeration dw_sses) {
...
//            System.err.println("domain " + domain);
            ...
            if (chainDomainMap.containsKey(chain)) {
                ArrayList domains = (ArrayList) chainDomainMap.get(chain);
                domains.add(domain);
            } else {
    ...
    public static BackboneSegment findMatch(SecStrucElement s, ArrayList backboneSegments) {
    ...
    public static void compareSSEs(tops.dw.protein.Protein dw_protein, translation.model.Protein gmt_protein) {
        ...
        HashMap chainDomainMap  = SSETest.convertDomains(dw_domains, dw_sselists);
        
        HashMap chainSegmentMap = gmt_protein.getBackboneSegmentsByDomain(chainDomainMap);
        ...
        while (dw_domains.hasMoreElements()) {
            ...
            HashMap domainSegmentMap = (HashMap) chainSegmentMap.get(String.valueOf(chain));
            ArrayList backboneSegments = (ArrayList) domainSegmentMap.get(String.valueOf(domain.getDomainID()));
            ...
            ArrayList matchedSegments = new ArrayList();
